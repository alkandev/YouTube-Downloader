...
window.title("Alkan | YouTube Video Downloader")
...
def Downloader():
    ...
    if checker==1:
        try:
            ...
            messagebox.showinfo("Alkan | Youtube Video Downloader",f"{video.title}\n Yükleme tamamlandı. \n Kaydedilen dizin: \n {dosyayolu}")
        except pytube.exceptions.RegexMatchError:
            messagebox.showerror("Alkan | Youtube Video Downloader","Hatalı link girildi, kontrol edip tekrar dene.")
